...
import AbsentionTable from "../components/dashboard/absention-table"; // Adjust the import based on your folder structure

// Define the type for the component props
interface AbsentionTableProps {
  filterValue: string;
  rowsPerPage: number;
  sortDescriptor: {
    column: string;
...
const meta: Meta<typeof AbsentionTable> = {
  title: "Components/AbsentionTable", // Storybook UI display name
  component: AbsentionTable,
  argTypes: {
...
const Template: StoryFn<AbsentionTableProps> = (args:any) => <AbsentionTable {...args} />;
